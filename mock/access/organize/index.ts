...
export default {
  'GET /api/gstdev-system/v1/depart/get-all-depart-to-tree': getTree,
  'GET /api/gstdev-system/v1/organize/getInfo': getInfo,
  'POST /api/gstdev-system/v1/organize/create': create,
  'PUT /api/gstdev-system/v1/organize/edit': edit,
};
